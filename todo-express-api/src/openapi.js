 ...
 * we inline it as a JS object so students can jump straight from a route
...
const todoSchema = {
    ...
    properties: {
        ...
        title: { type: "string", example: "Learn Express routing" },
...
const openapi = {
    ...
    info: {
        ...
        version: "1.0.0",
        description:
            "Educational Todo REST API built on Express — the simplified sibling of " +
            "todo-connect-api. Every endpoint below is implemented by the controllers " +
            "in src/controllers/, wired up by src/routes/todos.js.",
    },
    servers: [
