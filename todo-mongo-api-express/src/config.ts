 ...
 *   todo-mongo-api-express     3003   <-- this one
 * @author Bill Chen
 * -------------------------------------------------------------------------*/
...
export const PORT: number = parsePort(process.env["PORT"], 3003);

// The origin our future React dev server will run on. In a real project this
// would come from an env var; the fallback keeps the CORS story concrete for
// learners with nothing configured.
...
export const MONGODB_URI: string =
    process.env["MONGODB_URI"] ?? "mongodb://127.0.0.1:27017/todo_dev";
